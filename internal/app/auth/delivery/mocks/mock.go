...
func (m *MockAuthServiceInterface) Login(ctx context.Context, loginData *auth.LoginData) (*auth.AuthResponse, *models.ErrorResponse) {
	m.ctrl.T.Helper()
...
func (m *MockAuthServiceInterface) Logout(ctx context.Context, cookie string) (*auth.AuthResponse, *models.ErrorResponse) {
	m.ctrl.T.Helper()
...
func (m *MockAuthServiceInterface) Register(ctx context.Context, registerData *auth.RegisterData) (*auth.AuthResponse, *models.ErrorResponse) {
	m.ctrl.T.Helper()
...
func (m *MockAuthServiceInterface) Session(ctx context.Context, cookie string) (*auth.SessionResponse, *models.ErrorResponse) {
	m.ctrl.T.Helper()
