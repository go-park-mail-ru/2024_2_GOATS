...
//
//	mockgen -source=movie.go -destination=../user/service/mocks/movie_mock.go
//
...
func (m *MockMovieClientInterface) AddOrUpdateRating(ctx context.Context, movieID, userID, rating int32) error {
	m.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) AddOrUpdateRating(ctx, movieID, userID, rating any) *gomock.Call {
...
func (m *MockMovieClientInterface) DeleteUserRating(ctx context.Context, movieID, userID int32) error {
	m.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) DeleteUserRating(ctx, movieID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) GetActor(ctx, actorID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) GetCollection(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) GetFavorites(ctx, mvIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) GetMovie(ctx, mvID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMovieClientInterface) GetUserRating(ctx context.Context, movieID, userID int32) (int32, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) GetUserRating(ctx, movieID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) SearchActors(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMovieClientInterfaceMockRecorder) SearchMovies(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
