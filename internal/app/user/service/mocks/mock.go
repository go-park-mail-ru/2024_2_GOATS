...
//
//	mockgen -source=user.go -destination=../user/service/mocks/mock.go
//
...
func (mr *MockUserClientInterfaceMockRecorder) CreateSubscription(ctx, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserClientInterfaceMockRecorder) UpdateSubscriptionStatus(ctx, subID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
