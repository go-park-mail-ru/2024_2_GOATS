...
func (mr *MockUserRepositoryInterfaceMockRecorder) CreateUser(ctx, registerData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) DestroyFavorite(ctx, favData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) GetFavorites(ctx, usrID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) SaveUserAvatar(ctx, avatarName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) UpdatePassword(ctx, usrID, pass any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) UpdateProfileData(ctx, usrData any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) UserByEmail(ctx, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepositoryInterfaceMockRecorder) UserByID(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
