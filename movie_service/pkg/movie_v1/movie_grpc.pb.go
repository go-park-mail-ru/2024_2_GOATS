...
const (
	...
	MovieService_GetCollections_FullMethodName    = "/movie.MovieService/GetCollections"
	MovieService_GetMovieByGenre_FullMethodName   = "/movie.MovieService/GetMovieByGenre"
	MovieService_SearchMovies_FullMethodName      = "/movie.MovieService/SearchMovies"
	MovieService_SearchActors_FullMethodName      = "/movie.MovieService/SearchActors"
	MovieService_GetActor_FullMethodName          = "/movie.MovieService/GetActor"
	MovieService_GetMovieActors_FullMethodName    = "/movie.MovieService/GetMovieActors"
	MovieService_GetFavorites_FullMethodName      = "/movie.MovieService/GetFavorites"
	MovieService_GetUserRating_FullMethodName     = "/movie.MovieService/GetUserRating"
	MovieService_AddOrUpdateRating_FullMethodName = "/movie.MovieService/AddOrUpdateRating"
...
func (c *movieServiceClient) GetCollections(ctx context.Context, in *GetCollectionsRequest, opts ...grpc.CallOption) (*GetCollectionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetCollections_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) GetMovieByGenre(ctx context.Context, in *GetMovieByGenreRequest, opts ...grpc.CallOption) (*GetMovieByGenreResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetMovieByGenre_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) SearchActors(ctx context.Context, in *SearchActorsRequest, opts ...grpc.CallOption) (*SearchActorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_SearchActors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) GetActor(ctx context.Context, in *GetActorRequest, opts ...grpc.CallOption) (*GetActorResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetActor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) GetMovieActors(ctx context.Context, in *GetMovieActorsRequest, opts ...grpc.CallOption) (*GetMovieActorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetMovieActors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) GetFavorites(ctx context.Context, in *GetFavoritesRequest, opts ...grpc.CallOption) (*GetFavoritesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetFavorites_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) GetUserRating(ctx context.Context, in *GetUserRatingRequest, opts ...grpc.CallOption) (*GetUserRatingResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_GetUserRating_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) AddOrUpdateRating(ctx context.Context, in *AddOrUpdateRatingRequest, opts ...grpc.CallOption) (*AddOrUpdateRatingResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_AddOrUpdateRating_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MovieService_GetCollections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetCollections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_GetMovieByGenre_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetMovieByGenre_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_SearchActors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_SearchActors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_GetActor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetActor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_GetMovieActors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetMovieActors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_GetFavorites_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetFavorites_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_GetUserRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_GetUserRating_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MovieService_AddOrUpdateRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_AddOrUpdateRating_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
