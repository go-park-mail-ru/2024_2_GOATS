...
type UserRPCClient interface {
	...
	UpdateProfile(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error)
	UpdatePassword(ctx context.Context, in *UpdatePasswordRequest, opts ...grpc.CallOption) (*Nothing, error)
	GetFavorites(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error)
	SetFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error)
	ResetFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error)
	CheckFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error)
...
func (c *userRPCClient) UpdateProfile(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *userRPCClient) GetFavorites(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *userRPCClient) SetFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *userRPCClient) ResetFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *userRPCClient) CheckFavorite(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
type UserRPCServer interface {
	...
	UpdateProfile(context.Context, *Nothing) (*Nothing, error)
	UpdatePassword(context.Context, *UpdatePasswordRequest) (*Nothing, error)
	GetFavorites(context.Context, *Nothing) (*Nothing, error)
	SetFavorite(context.Context, *Nothing) (*Nothing, error)
	ResetFavorite(context.Context, *Nothing) (*Nothing, error)
	CheckFavorite(context.Context, *Nothing) (*Nothing, error)
...
func (UnimplementedUserRPCServer) UpdateProfile(context.Context, *Nothing) (*Nothing, error) {
...
func (UnimplementedUserRPCServer) GetFavorites(context.Context, *Nothing) (*Nothing, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFavorites not implemented")
}
func (UnimplementedUserRPCServer) SetFavorite(context.Context, *Nothing) (*Nothing, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetFavorite not implemented")
}
func (UnimplementedUserRPCServer) ResetFavorite(context.Context, *Nothing) (*Nothing, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetFavorite not implemented")
}
func (UnimplementedUserRPCServer) CheckFavorite(context.Context, *Nothing) (*Nothing, error) {
...
func _UserRPC_UpdateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRPCServer).UpdateProfile(ctx, req.(*Nothing))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserRPC_GetFavorites_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRPCServer).GetFavorites(ctx, req.(*Nothing))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserRPC_SetFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRPCServer).SetFavorite(ctx, req.(*Nothing))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserRPC_ResetFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRPCServer).ResetFavorite(ctx, req.(*Nothing))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserRPC_CheckFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRPCServer).CheckFavorite(ctx, req.(*Nothing))
	}
	return interceptor(ctx, in, info, handler)
}
