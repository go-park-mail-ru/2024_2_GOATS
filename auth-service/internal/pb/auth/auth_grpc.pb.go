...
func (c *authClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (UnimplementedAuthServer) Logout(context.Context, *LogoutRequest) (*AuthResponse, error) {
